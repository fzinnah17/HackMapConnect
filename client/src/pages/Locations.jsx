...
const Locations = () => {
    ...
    useEffect(() => {
        // Temporary hardcoded data to avoid calling LocationsAPI
        ...
        setVenueNames({
            venue1: hardcodedLocations[0].name,
            venue2: hardcodedLocations[1].name,
            venue3: hardcodedLocations[2].name,
            venue4: hardcodedLocations[3].name,
        });
        setListeners();
    }, []);
